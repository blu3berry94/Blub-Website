        ...
        $(window).on("load", function() {
            ...
            function updateStatus(online, current) {
                ...
                if (online) {
                    ...
                    if ((current > 1) || (current < 1)) {
                        statusStatusDiv.html("<span>" + current + "</span> " + players_online);
                    } else {
                        statusStatusDiv.html("<span>" + current + "</span> " + player_online);
                    }
                } else {
                    statusStatusDiv.empty();
            ...
            function updateDiscordStatus(presence_count) {
                ...
                if ((presence_count > 1) || (presence_count < 1)) {
                    discordStatusDiv.html("<span>" + presence_count + "</span> " + users_online);
                } else {
                    discordStatusDiv.html("<span>" + presence_count + "</span> " + user_online);
                }
            }
        });
    }
        ...
        (function() {
            $('.button-checkbox').each(function() {
                ...
                function updateDisplay() {
                    ...
                    if (isChecked) {
                        $button.removeClass('btn-secondary').addClass('btn-' + color + ' active');
                    } else {
                        $button.removeClass('btn-' + color + ' active').addClass('btn-secondary');
                    }
                }
